	...
	return (
		<div className="relative flex flex-col">
			...
			<motion.img
				...
				className="absolute top-32 -left-10 scale-110 opacity-50"
				initial={{ opacity: 0 }}
				animate={{ opacity: 0.5 }}
				transition={{ duration: 1, ease: "easeOut" }}
			/>
			<div className="flex flex-col">
				<main className="min-h-screen flex-1 flex justify-center items-center">
					<div className="z-50 w-4/5 flex flex-col gap-4">
						<motion.h1
						...
						<div className="flex justify-center gap-12">
							<motion.img
								src="/avatar.jpg"
								alt=""
								className="w-[512px] aspect-square object-cover"
				...
				<section className="py-20 flex flex-col relative overflow-hidden">
					...
					<motion.div
						className="w-4/5 mx-auto mt-10 border border-white"
						{...fadeIn}
					...
					<motion.h3
						className="mt-20 text-center uppercase text-7xl font-bold font-sans bg-linear-to-tr from-cyan-500 to-white bg-clip-text text-transparent"
						{...fadeIn}
					>
						recognitions
					</motion.h3>
					<motion.p
						className="w-3/5 mx-auto mt-14 text-center text-white text-3xl font-sans"
						{...fadeIn}
						transition={{ ...fadeIn.transition, delay: 0.1 }}
					>
